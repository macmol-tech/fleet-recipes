...
class FleetImporter(Processor):
    ...
    input_variables = {
        ...
        "gitops_pr_base": {
            "required": False,
            "default": "main",
            "description": "Base branch for pull requests (default: main). Use FLEET_GITOPS_PR_BASE environment variable.",
        },
    ...
    def _run_gitops_workflow(self):
        ...
        gitops_pr_base = self.env.get("gitops_pr_base", "main")
    ...
    def _create_pull_request(
        ...
        Args:
            ...
            base_branch: Base branch to target for the PR (default: main)
